...
if object_id('[final].[mcaid_claim_header]', 'U') is not null 
drop table [final].[mcaid_claim_header]
create table [final].[mcaid_claim_header]
...
if object_id('[final].[mcaid_claim_line]', 'U') is not null
drop table [final].[mcaid_claim_line];
create table [final].[mcaid_claim_line]
([id_mcaid] varchar(200)
,[claim_header_id] bigint
