...
input <- data.table::fread("https://raw.githubusercontent.com/PHSKC-APDE/claims_data/master/claims_db/phclaims/table_dependencies.csv")
#input <- data.table::fread("C:/Users/mathesal/OneDrive - King County/github/claims/claims_db/phclaims/table_dependencies.csv")
...
# Set up a function to create teh Graphviz text
...
Code to create this document is found here: <https://github.com/PHSKC-APDE/claims_data/blob/master/claims_db/phclaims/table_dependencies.Rmd>
...
mcare_elig_edges <- edges %>% 
  filter(str_detect(from, "mcare_elig") | str_detect(to, "mcare_elig"))
