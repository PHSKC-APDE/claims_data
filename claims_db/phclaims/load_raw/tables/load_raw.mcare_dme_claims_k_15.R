...
load_table_from_file_f(conn = db.claims51, 
                       #config_file = file.path(git_path, "C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_dme_claims_k_15.yaml"),
