...
#### Import Medicare data from csv files,outpatient base and outpatient revenue claims 2017 ####
...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","create_load_raw_mcare_outpatient_base_claims_k_17.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","load_raw_mcare_outpatient_claims_17.yaml"),
                       overall = T, ind_yr = F, test_mode = F)

#4,368,292 rows copied.
#Clock Time (ms.) Total: 320,718 Average : (13620.35 rows per sec.)
...
#####################################
#####################################
##outpatient revenue file##
###########################


#### STEP 2: Create table shell ####
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","create_load_raw_mcare_outpatient_revenue_center_k_17.yaml"),
               #config_url = "https://raw.githubusercontent.com/PHSKC-APDE/pers_shuva/main/create_load_raw_mcare_inpatient_base_claims_k_17.yaml?token=ALY7265RMO3CACOE5X3GGGC6HXY5I",
               overall = T, ind_yr = F, test_mode = F)
...
#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","load_raw_mcare_outpatient_revenue_center_k_17.yaml"),
                       overall = T, ind_yr = F, test_mode = F)

#24,868,954 rows copied.
#Clock Time (ms.) Total: 844515 Average : (29447.62 rows per sec.)
