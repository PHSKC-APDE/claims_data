#### CODE TO LOAD APCD MEDICAL_CLAIM_HEADER TABLES
# Eli Kern, PHSKC (APDE)
#
# 2020-08
...
load_load_raw.apcd_medical_claim_header_full_f <- function(etl_date_min = NULL,
                                            etl_date_max = NULL,
  ...
  ### Set table name part
  table_name_part <- "apcd_medical_claim_header"
