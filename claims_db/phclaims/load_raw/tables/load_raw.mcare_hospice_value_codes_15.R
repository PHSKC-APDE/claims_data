...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/","create_load_raw.mcare_hospice_value_codes_15.yaml"),
               overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/","load_raw.mcare_hospice_value_codes_15.yaml"),
                       overall = T, ind_yr = F, test_mode =F)

#(6 vars, 295,497 obs)
#295497 rows copied.
#Network packet size (bytes): 4096
#Clock Time (ms.) Total     : 9078   Average : (32550.89 rows per sec.)
