...
create_table_f(conn = db.claims51, 
               ...
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_snf_base_claims_k_14.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       ...
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_snf_base_claims_k_14.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
...
#Clock Time (ms.) Total     : 5766   Average : (15410.86 rows per sec.)
##(171 vars, 88,859 obs)
