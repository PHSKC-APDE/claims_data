...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables","create_load_raw.mcare_bcarrier_line_k_15.yaml"),
               overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables","load_raw.mcare_bcarrier_line_k_15.yaml"),
               overall = T, ind_yr = F, test_mode = F)
...
## 76 vars 32,316,306 obs Stata
##32316306 rows copied.
##Network packet size (bytes): 4096
##Clock Time (ms.) Total     : 2461641 Average : (13127.95 rows per sec.)
