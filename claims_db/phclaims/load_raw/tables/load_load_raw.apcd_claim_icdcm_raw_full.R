#### CODE TO LOAD APCD ICDCM TABLES
# Eli Kern, PHSKC (APDE)
#
# 2020-08
...
load_load_raw.apcd_icdcm_full_f <- function(etl_date_min = NULL,
                                            etl_date_max = NULL,
                                            etl_delivery_date = NULL,
                                            etl_note = NULL) {
  
  ### Set table name part
  table_name_part <- "apcd_claim_icdcm_raw"
  ...
  load_table_from_file_f(conn = db_claims,
                         ...
                         overall = F, ind_yr = T, combine_yr = T, test_mode = F, server = "phclaims")
