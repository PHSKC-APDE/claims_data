...
#### Import Medicare data from csv files,SNF base and SNF revenue claims 2017 ####
...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","create_load_raw_mcare_snf_base_claims_k_17.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","load_raw_mcare_snf_base_claims_k_17.yaml"),
                       overall = T, ind_yr = F, test_mode = F)

#82,756 rows copied.
#Clock Time (ms.) Total:5078   Average : (16296.97 rows per sec.)
...
#### STEP 2: Create table shell ####
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","create_load_raw_mcare_snf_revenue_center_k_17.yaml"),
               #config_url = "https://raw.githubusercontent.com/PHSKC-APDE/pers_shuva/master/create_load_raw_mcare_inpatient_base_claims_k_17.yaml?token=ALY7265RMO3CACOE5X3GGGC6HXY5I",
               overall = T, ind_yr = F, test_mode = F)
...
#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","load_raw_mcare_snf_revenue_center_k_17.yaml"),
                       overall = T, ind_yr = F, test_mode = F)

#701,643 rows copied.
#Clock Time (ms.) Total:  8750   Average : (80187.77 rows per sec.)