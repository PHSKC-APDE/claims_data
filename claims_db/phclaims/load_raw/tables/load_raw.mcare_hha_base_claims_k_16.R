...
#### Import Medicare data from csv files, --HH base claims ####
...
create_table_f(conn = db.claims51, 
               ...
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_hha_base_claims_k_16.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       ...
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_hha_base_claims_k_16.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
...
#Clock Time (ms.) Total     : 5187   Average : (14741.66 rows per sec.)
##(99 vars, 76,465 obs)
