...
create_table_f(conn = db.claims51, 
               ...
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_dme_line_k_15.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       ...
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_dme_line_k_15.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
...
#Clock Time (ms.) Total     : 100797 Average : (21997.65 rows per sec.)
##(60 vars, 2,217,297 obs)
