...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","create_load_raw_mcare_inpatient_revenue_center_k_17.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","load_raw_mcare_inpatient_revenue_center_k_17.yaml"),
                       overall = T, ind_yr = F, test_mode = F)
#3,251,242 rows copied.
#Clock Time (ms.) Total     : 47390  Average : (68606.08 rows per sec.)
