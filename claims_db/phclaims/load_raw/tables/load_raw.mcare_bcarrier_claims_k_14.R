...
#### Import Medicare data from csv files, -b carrier claims) ####
...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/","create_load_raw.mcare_bcarrier_claims_k_14.yaml"),
               overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/","load_raw.mcare_bcarrier_claims_k_14.yaml"),
                       overall = T, ind_yr = F, test_mode = F)
...
##(56 vars, 15,294,707 obs) stata
##15294707 rows copied.
##Network packet size (bytes): 4096
##Clock Time (ms.) Total     : 642281 Average : (23813.11 rows per sec.)
