...
create_table_f(conn = db.claims51, 
               ...
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_snf_base_claims_k_16.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       ...
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_snf_base_claims_k_16.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
...
##Clock Time (ms.) Total     : 5141   Average : (16764.25 rows per sec.)
##(171 vars, 86,185 obs)
