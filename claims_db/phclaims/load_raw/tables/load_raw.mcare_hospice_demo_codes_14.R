...
#### Import Medicare data from csv files, --Hospice Demo Codes ####
...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_hospice_demo_codes_14.yaml"),
                                             overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                        config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_hospice_demo_codes_14.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
...
##Clock Time (ms.) Total     : 1016   Average : (13.78 rows per sec.)
