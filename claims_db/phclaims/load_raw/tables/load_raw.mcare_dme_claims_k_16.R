...
#### Import Medicare data from csv files, --Durable Medical Equipment (DME) claims####
...
create_table_f(conn = db.claims51, 
               ...
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_dme_claims_k_16.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       ...
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_dme_claims_k_16.yaml"),
                                              overall = T, ind_yr = F, test_mode = F)
##1269267 rows copied.
##Network packet size (bytes): 4096
##Clock Time (ms.) Total     : 49531  Average : (25625.71 rows per sec.)
##(58 vars, 1,269,267 obs)
