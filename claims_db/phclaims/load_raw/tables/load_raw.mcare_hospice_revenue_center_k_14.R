...
#### Import Medicare data from csv files, --Hospice Revenue Center ####
...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_hospice_revenue_center_k_14.yaml"),
                                             overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                        config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_hospice_revenue_center_k_14.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
#(29 vars, 1,133,331 obs)
#1133331 rows copied.
#Network packet size (bytes): 4096
#Clock Time (ms.) Total     : 22453  Average : (50475.70 rows per sec.)
