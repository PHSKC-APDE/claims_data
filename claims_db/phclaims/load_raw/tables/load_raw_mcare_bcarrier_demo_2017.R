...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","create_load_raw_mcare_bcarrier_demo_17.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/sdawadi/Desktop/Mcare_yaml","load_raw_mcare_bcarrier_demo_2017.yaml"),
                       overall = T, ind_yr = F, test_mode = F)


#198737 rows copied.
#Clock Time (ms.) Total: 2,281   Average : (87127.14 rows per sec.)
