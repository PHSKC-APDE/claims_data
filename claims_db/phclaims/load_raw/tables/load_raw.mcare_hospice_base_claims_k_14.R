...
create_table_f(conn = db.claims51, 
                config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_hospice_base_claims_k_14.yaml"),
                                             overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_hospice_base_claims_k_14.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
##67033 rows copied.
##Network packet size (bytes): 4096
##Clock Time (ms.) Total     : 4938   Average : (13574.93 rows per sec.)
##(96 vars, 67,033 obs)
