...
#### Import Medicare data from csv files, --B carrier line ####
...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables","create_load_raw.mcare_bcarrier_line_k_16.yaml"),
               overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables","load_raw.mcare_bcarrier_line_k_16.yaml"),
               overall = T, ind_yr = F, test_mode = F)
...
## 76 vars 32,486,378  obs Stata
## 32,486,378 rows copied.
##Network packet size (bytes): 4096
##Clock Time (ms.) Total     : 2242219 Average : (14488.50 rows per sec.)
