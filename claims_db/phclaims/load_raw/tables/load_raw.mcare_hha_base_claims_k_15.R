...
create_table_f(conn = db.claims51, 
               ...
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_hha_base_claims_k_15.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       ...
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_hha_base_claims_k_15.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
...
##Clock Time (ms.) Total     : 4718   Average : (15426.88 rows per sec.)
##(99 vars, 72,784 obs)
