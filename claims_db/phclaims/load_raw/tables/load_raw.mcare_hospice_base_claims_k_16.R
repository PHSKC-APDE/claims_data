...
#### Import Medicare data from csv files, --Hospice Base Claims ####
...
create_table_f(conn = db.claims51, 
               ...
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_hospice_base_claims_k_16.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       ...
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_hospice_base_claims_k_16.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
##77598 rows copied.
##Network packet size (bytes): 4096
##Clock Time (ms.) Total     : 4922   Average : (15765.54 rows per sec.)
##(96 vars, 77,598 obs)
