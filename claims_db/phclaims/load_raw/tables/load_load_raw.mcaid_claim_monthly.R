...
load_load_raw.mcaid_claim_monthly_f <- function(etl_date_min = NULL,
                                                etl_date_max = NULL,
  ...
  if (qa_file_row == T) {
    ...
    qa_rows_file <- qa_file_row_count_f(config_url = "https://raw.githubusercontent.com/PHSKC-APDE/claims_data/master/claims_db/phclaims/load_raw/tables/load_load_raw.mcaid_claim_monthly.yaml",
                                        overall = F, ind_yr = T)
