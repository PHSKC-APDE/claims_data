...
#### Import Medicare data from csv files, --Outpatient Revenue Center####
...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables","create_load_raw.mcare_outpatient_revenue_center_k_15.yaml"),
               overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables","load_raw.mcare_outpatient_revenue_center_k_15.yaml"),
                       overall = T, ind_yr = F, test_mode = F)


###Troubleshooting yaml error
##config_file <- file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/","load_raw.mcare_outpatient_revenue_center_k_14.yaml")
##table_config <- yaml::read_yaml(config_file)

##(48 vars, 23,947,014 obs) stata
##23,947,014 rows copied.
##Network packet size (bytes): 4096
##Clock Time (ms.) Total     : 782156 Average : (30616.67 rows per sec.)
