...
#### Import APCD data from Amazon S3 bucket to SQL Server - load_raw.apcd_medical_claim_column_add ####
...
read_path <- paste0(write_path, "medical_claim_column_add_export/")
