...
#### Import Medicare data from csv files, --Durable Medical Equipment (DME) demo codes ####
...
create_table_f(conn = db.claims51, 
               ...
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "create_load_raw.mcare_dme_demo_codes_16.yaml"),
...
load_table_from_file_f(conn = db.claims51, 
                       ...
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/", "load_raw.mcare_dme_demo_codes_16.yaml"),
                                              overall = T, ind_yr = F, test_mode =F)
...
##Clock Time (ms.) Total     : 63     Average : (106380.95 rows per sec.)
##(6 vars, 6,702 obs)
