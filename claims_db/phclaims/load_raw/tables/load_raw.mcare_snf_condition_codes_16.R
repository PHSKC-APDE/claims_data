...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/","create_load_raw.mcare_snf_condition_codes_16.yaml"),
               overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/","load_raw.mcare_snf_condition_codes_16.yaml"),
                       overall = T, ind_yr = F, test_mode =F)

#(5 vars, 30,361 obs)
#30361 rows copied.
#Network packet size (bytes): 4096
#Clock Time (ms.) Total     : 656    Average : (46282.01 rows per sec.)
