...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables","create_load_raw.mcare_outpatient_revenue_center_k_14.yaml"),
...
##(39 vars, 21,697,685 obs) stata
##21,697,685 rows copied.
##Network packet size (bytes): 4096
##Clock Time (ms.) Total     : 651953 Average : (33281.06 rows per sec.)
