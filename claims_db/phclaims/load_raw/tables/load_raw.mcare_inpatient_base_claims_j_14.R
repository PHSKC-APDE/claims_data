...
#### Import Medicare data from csv files, --Inpatient base claims ####
...
create_table_f(conn = db.claims51, 
               config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/","create_load_raw.mcare_inpatient_base_claims_j_14.yaml"),
               overall = T, ind_yr = F, test_mode = F)

#### STEP 3: Load data from CSV ####
load_table_from_file_f(conn = db.claims51, 
                       config_file = file.path("C:/Users/shernandez/code/claims_data/claims_db/phclaims/load_raw/tables/","load_raw.mcare_inpatient_base_claims_j_14.yaml"),
                       overall = T, ind_yr = F, test_mode =F)



##(264 vars, 166,778 obs)
##166778 rows copied.
##Network packet size (bytes): 4096
##Clock Time (ms.) Total     : 17047  Average : (9783.42 rows per sec.)
