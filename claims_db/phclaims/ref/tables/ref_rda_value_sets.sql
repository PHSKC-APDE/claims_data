...
/*
IF OBJECT_ID('[ref].[rda_value_sets]', 'U') IS NOT NULL
DROP TABLE [ref].[rda_value_sets];
SELECT [value_set_group]
      ...
      ,[from_date]
      ,[to_date]
INTO [ref].[rda_value_sets]
FROM [dbo].[ref_rda_value_sets];

ALTER TABLE [ref].[rda_value_sets] ADD CONSTRAINT [PK_ref_rda_value_sets] PRIMARY KEY CLUSTERED 
([value_set_name] ASC
...
IF OBJECT_ID('[ref].[rda_value_sets]', 'U') IS NOT NULL
DROP TABLE [ref].[rda_value_sets];
CREATE TABLE [ref].[rda_value_sets]
...
,[from_date] DATE NULL
,[to_date] DATE NULL
,CONSTRAINT [PK_ref_rda_value_sets] PRIMARY KEY CLUSTERED([value_set_name], [data_source_type], [sub_group], [code_set], [code])
);
GO

TRUNCATE TABLE [ref].[rda_value_sets];

-- Mental Health Value Sets
INSERT INTO [ref].[rda_value_sets]
([value_set_group]
,[value_set_name]
,[data_source_type]
,[sub_group]
