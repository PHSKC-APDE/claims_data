##Script to load QRS measure value sets to SQL for 2025
...
hedis_file_path <- "//dphcifs/APDE-CDIP/HEDIS/2025_QRS_Only_Free/" #!!!!! UPDATE THIS EACH YEAR !!!!!#
hedis_year <- 2025L #!!!!! UPDATE THIS EACH YEAR !!!!!#
...
hedis_measure <- read.xlsx(
  xlsxFile= paste0(hedis_file_path, "HEDIS for QRS MY 2025 VSD 2025-03-31.xlsx"), #!!!!! UPDATE THIS EACH YEAR !!!!!#
...
hedis_medication_measure <- read.xlsx(
  xlsxFile= paste0(hedis_file_path, "HEDIS MY 2025 Medication List Directory 2025-05-15.xlsx"), #!!!!! UPDATE THIS EACH YEAR !!!!!#
