...
CREATE CLUSTERED INDEX idx_cl_#v_perf_tpm_numerator ON #v_perf_tpm_numerator([first_service_date]);
...
WHERE [first_service_date] BETWEEN ''' + CAST(@start_month_date AS CHAR(10)) + ''' AND ''' + CAST(@end_month_date AS CHAR(10)) + ''';
CREATE CLUSTERED INDEX idx_cl_#v_perf_tpm_denominator ON #v_perf_tpm_denominator([first_service_date]);
...
WHERE [first_service_date] BETWEEN ''' + CAST(@start_month_date AS CHAR(10)) + ''' AND ''' + CAST(@end_month_date AS CHAR(10)) + ''';
CREATE CLUSTERED INDEX idx_cl_#v_perf_tpo_numerator ON #v_perf_tpo_numerator([first_service_date]);
...
WHERE [first_service_date] BETWEEN ''' + CAST(@start_month_date AS CHAR(10)) + ''' AND ''' + CAST(@end_month_date AS CHAR(10)) + ''';
CREATE CLUSTERED INDEX idx_cl_#v_perf_tpo_denominator ON #v_perf_tpo_denominator([first_service_date]);
...
,[age] INT
,[episode_id] INT
,[episode_first_service_date] DATE
,[episode_last_service_date] DATE
,[inpatient_index_stay] INT
,[readmission_first_service_date] DATE
,[readmission_last_service_date] DATE
...
SELECT
 [year_month]
,[episode_last_service_date] AS [event_date]
,[id_mcaid]
,[measure_id]
,[inpatient_index_stay] AS [denominator]
