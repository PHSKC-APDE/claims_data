...
CONCAT(CASE WHEN RACE1_NAME = 'NOT PROVIDED' OR RACE1_NAME = 'OTHER' THEN NULL ELSE UPPER(RACE1_NAME) END, 
	...
	CASE WHEN RACE4_NAME = 'NOT PROVIDED' OR RACE4_NAME = 'OTHER' THEN NULL ELSE UPPER(RACE4_NAME) END,
	CASE WHEN HISPANIC_ORIGIN_NAME = 'NOT PROVIDED' OR HISPANIC_ORIGIN_NAME = 'OTHER' THEN NULL ELSE UPPER(HISPANIC_ORIGIN_NAME) END) AS race_all,
