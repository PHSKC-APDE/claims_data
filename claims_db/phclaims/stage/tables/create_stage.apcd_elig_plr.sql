--Code to create stage.apcd_elig_plr_DATE table
...
IF object_id('PHClaims.stage.apcd_elig_plr_2017', 'U') is not null DROP TABLE PHClaims.stage.apcd_elig_plr_2017;
CREATE TABLE PHClaims.stage.apcd_elig_plr_2017 (
	id_apcd						 bigint,
