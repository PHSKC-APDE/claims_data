...
load_stage.mcare_claim_pharm_f <- function() {
  ...
  odbc::dbGetQuery(inthealth, glue::glue_sql(
    ...
    cast(ptnt_pay_amt as numeric(38,3)) as ptnt_pay_amt,
    cast(othr_troop_amt as numeric(38,3)) as othr_troop_amt,
    cast(lics_amt as numeric(38,3)) as lics_amt,
    cast(plro_amt as numeric(38,3)) as plro_amt,
    cast(cvrd_d_plan_pd_amt as numeric(38,3)) as cvrd_d_plan_pd_amt,
    cast(ncvrd_plan_pd_amt as numeric(38,3)) as ncvrd_plan_pd_amt,
    cast(tot_rx_cst_amt as numeric(38,3)) as tot_rx_cst_amt,
    ...
    fill_num,
	cast(ptpayamt as numeric(38,3)) as ptnt_pay_amt,
    cast(othtroop as numeric(38,3)) as othr_troop_amt,
    cast(lics_amt as numeric(38,3)) as lics_amt,
    cast(plro_amt as numeric(38,3)) as plro_amt,
    cast(cpp_amt as numeric(38,3)) as cvrd_d_plan_pd_amt,
    cast(npp_amt as numeric(38,3)) as ncvrd_plan_pd_amt,
    cast(totalcst as numeric(38,3)) as tot_rx_cst_amt,
    gcdf as dosage_form_code,
    gcdf_desc as dosage_form_code_desc,
    [str] as strength,
    ncpdp_id as pharmacy_id,
