--Code to create stage.apcd_elig_timevar table
...
IF object_id('PHClaims.stage.apcd_elig_timevar', 'U') is not null DROP TABLE PHClaims.stage.apcd_elig_timevar;
CREATE TABLE PHClaims.stage.apcd_elig_timevar (
	id_apcd bigint,
	from_date date,
	to_date date,
	contiguous tinyint,
