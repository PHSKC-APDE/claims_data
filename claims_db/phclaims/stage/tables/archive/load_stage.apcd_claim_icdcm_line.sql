--Code to load data to stage.apcd_claim_icdcm_line table
...
-------------------
insert into PHClaims.stage.apcd_claim_icdcm_line with (tablock)
select distinct a.id_apcd, a.extract_id, b.medical_claim_header_id as 'claim_header_id', a.medical_claim_service_line_id as 'claim_line_id',
