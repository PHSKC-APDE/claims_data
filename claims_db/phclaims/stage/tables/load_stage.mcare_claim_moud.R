...
load_stage.mcare_claim_moud_f <- function() {
  ...
  odbc::dbGetQuery(inthealth, glue::glue_sql(
    ...
    ---------------------------
    drop table if exists #mcare_moud_proc_1;
    ...
    ---------------------------
    drop table if exists #mcare_moud_proc_2;
    select distinct a.*,
    ...
    ---------------------------
    drop table if exists #mcare_moud_proc_3;
    select distinct
    	id_mcare,
    	claim_header_id,
    	first_service_date,
    ...
    ---------------------------
    drop table if exists #mcare_moud_pharm_1;
    ...
    a.days_supply_num as moud_days_supply
    ...
    drop table if exists #mcare_moud_pharm_2
    ...
    */
    ...
    ---------------------------
    drop table if exists #mcare_moud_union_1;
    select 
    	id_mcare,
    	claim_header_id,
    	first_service_date,
    ...
    */
    ...
    drop table if exists #mcare_moud_union_2;
    select id_mcare,
    last_service_date,
    meth_proc_flag,
    bup_proc_flag,
    ...
    drop table if exists #mcare_moud_union_3 
    select *, 
    ...
    drop table if exists #tempcolumns2
    select a.dupdate, b.*
    into #tempcolumns2
    ...
    drop table if exists #tempcolumns3
    select *, 
    ...
    drop table if exists #mcare_moud_union_4
    ...
    drop table if exists #mcare_moud_union_final
    ...
    drop table if exists #temp_meth_1;
    ...
    drop table if exists #temp_meth_2;
    select *,
