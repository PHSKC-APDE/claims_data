--Code to create stage.apcd_claim_procedure table
--Procedure codes in long format at claim header level
--Eli Kern (PHSKC-APDE)
--2019-8-22

if object_id('PHClaims.stage.apcd_claim_procedure', 'U') is not null drop table PHClaims.stage.apcd_claim_procedure;
create table PHClaims.stage.apcd_claim_procedure (
	id_apcd bigint,
	extract_id int,
