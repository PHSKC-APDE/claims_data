...
| covd | Medicaid coverage duration during the requested date range (integer days) | numeric | >=1
| covper | Percent of the requested date range with Medicaid coverage | numeric | >0.0 and <=100.0
| duald | Medicare-Medicaid dual eligibility coverage during requested date range (integer days) | numeric | >=0
