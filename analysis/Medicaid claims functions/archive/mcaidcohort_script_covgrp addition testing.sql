...
select cov.id, 
	...
	cov.covd, cov.covper, cov.ccovd_max, cov.covgap_max, dual.duald, dual.dualper, dual.dual_flag, covgrp.new_adult, covgrp.apple_kids, covgrp.older_adults, covgrp.family_med, covgrp.family_planning,
	covgrp.former_foster, covgrp.foster, covgrp.caretaker_adults, covgrp.partial_duals, covgrp.disabled, covgrp.pregnancy, demo.dobnew, demo.age, demo.age_grp7, demo.gender_mx, demo.male, demo.female, 
...
--3rd table - Medicaid coverage groups
inner join (
select id, max(new_adult) as 'new_adult', max(apple_kids) as 'apple_kids', max(older_adults) as 'older_adults',
