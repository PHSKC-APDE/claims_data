...
from (
	...
	iif(x.from_date <= @begin and x.to_date >= @end and x.rac_code in ('1201','1217'), datediff(day, @begin, @end) + 1, 
	
	/**if coverage period begins before date range start and ends within date range */
	iif(x.from_date <= @begin and x.to_date < @end and x.rac_code in ('1201','1217'), datediff(day, @begin, x.to_date) + 1,

	/**if coverage period begins after date range start and ends after date range end */
	iif(x.from_date > @begin and x.to_date >= @end and x.rac_code in ('1201','1217'), datediff(day, x.from_date, @end) + 1,

	/**if coverage period begins after date range start and ends before date range end */
	iif(x.from_date > @begin and x.to_date < @end and x.rac_code in ('1201','1217'), datediff(day, x.from_date, x.to_date) + 1,

	0)))) as 'nadultd',

	--disabled
	/**if coverage period fully contains date range then person time is just date range */
	iif(x.from_date <= @begin and x.to_date >= @end and x.rac_code in ('1002','1003','1005','1014','1015','1016','1017',
	...
	'1105','1107','1110','1111','1121','1126','1134','1147','1150','1151','1153','1162','1163','1164','1165','1168','1169',
	'1175','1197','1219','1221','1224','1225','1237','1239','1242','1243','1245','1247','1252','1253','1254','1255','1258',
	'1261','1263','1267','1268','1269'), datediff(day, @begin, x.to_date) + 1,
	...
	'1105','1107','1110','1111','1121','1126','1134','1147','1150','1151','1153','1162','1163','1164','1165','1168','1169',
	'1175','1197','1219','1221','1224','1225','1237','1239','1242','1243','1245','1247','1252','1253','1254','1255','1258',
	'1261','1263','1267','1268','1269'), datediff(day, x.from_date, @end) + 1,
	...
	'1105','1107','1110','1111','1121','1126','1134','1147','1150','1151','1153','1162','1163','1164','1165','1168','1169',
	'1175','1197','1219','1221','1224','1225','1237','1239','1242','1243','1245','1247','1252','1253','1254','1255','1258',
	'1261','1263','1267','1268','1269'), datediff(day, x.from_date, x.to_date) + 1,

	0)))) as 'disabled',

	--non-disabled
	/**if coverage period fully contains date range then person time is just date range */
	iif(x.from_date <= @begin and x.to_date >= @end and x.rac_code in ('1000','1001','1004','1026','1027','1028','1029','1030',
	...
	'1123','1124','1140','1146','1148','1149','1152','1174','1196','1198','1199','1200','1202','1203','1204','1205','1206','1207',
	'1208','1209','1210','1211','1212','1213','1218','1222','1223','1236','1238','1240','1241','1244','1246','1248','1249','1250',
	'1251','1256','1257','1260','1264','1265','1266'), datediff(day, @begin, x.to_date) + 1,
	...
	'1123','1124','1140','1146','1148','1149','1152','1174','1196','1198','1199','1200','1202','1203','1204','1205','1206','1207',
	'1208','1209','1210','1211','1212','1213','1218','1222','1223','1236','1238','1240','1241','1244','1246','1248','1249','1250',
	'1251','1256','1257','1260','1264','1265','1266'), datediff(day, x.from_date, @end) + 1,
	...
	'1123','1124','1140','1146','1148','1149','1152','1174','1196','1198','1199','1200','1202','1203','1204','1205','1206','1207',
	'1208','1209','1210','1211','1212','1213','1218','1222','1223','1236','1238','1240','1241','1244','1246','1248','1249','1250',
	'1251','1256','1257','1260','1264','1265','1266'), datediff(day, x.from_date, x.to_date) + 1,

	0)))) as 'nondisabled'

	from PHClaims.dbo.mcaid_elig_rac as x
	where x.from_date < @end and x.to_date > @begin
) as y
group by y.id