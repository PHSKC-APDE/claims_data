 ...
 Select distinct CLM_TYPE_NAME, count(MEDICAID_RECIPIENT_ID)
 From  PHClaims.dbo.NewClaims
 Group By CLM_TYPE_NAME

 
 Select distinct CLM_TYPE_CID, count(MEDICAID_RECIPIENT_ID)
 From  PHClaims.dbo.NewClaims
 Group By CLM_TYPE_CID

 Select distinct CLM_TYPE_CID, CLM_TYPE_NAME, count(MEDICAID_RECIPIENT_ID)
 From  PHClaims.dbo.NewClaims
 Group By CLM_TYPE_CID, CLM_TYPE_NAME
